...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($first_name) || empty($last_name)) {
        ...
        if ($stmt->execute()) {
            $success = 'Actor actualizado exitosamente';
            $actor['first_name'] = $first_name;
            $actor['last_name'] = $last_name;
        } else {
            $error = 'Error al actualizar el actor: ' . $conn->error;
        }
...
<head>
    ...
    <title>Editar Actor - Sakila</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h2>Editar Actor</h2>
                <div class="actor-id">ID: <?php echo $actor['actor_id']; ?></div>
            </div>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" 
                           id="first_name" 
                           name="first_name" 
                           value="<?php echo htmlspecialchars($actor['first_name']); ?>"
                           required 
                           autofocus
                           maxlength="45">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           id="last_name" 
                           name="last_name" 
                           value="<?php echo htmlspecialchars($actor['last_name']); ?>"
                           required
                           maxlength="45">
                </div>
